...
Optional: Xcode Cloud → point at this repo, workflow on the same scheme (`managment-company`). GitHub Actions runs simulator build + tests on push/PR to `main`, `master`, `develop`.
