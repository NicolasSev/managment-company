...
struct LiveDocumentHubClient: DocumentHubClient {
    ...
    func fetch(search: String, entityType: String, fileType: String, page: Int, perPage: Int) async throws -> (files: [DocumentFile], total: Int) {
        let path = DocumentHubViewModel.listPath(search: search, entityType: entityType, fileType: fileType, page: page, perPage: perPage)
...
/// Searchable cross-portfolio document workspace (GAP-044).
@MainActor
final class DocumentHubViewModel: ObservableObject {
    ...
    private func fetch(reset: Bool) async {
        ...
        do {
            let result = try await client.fetch(
                search: search, entityType: entityTypeFilter, fileType: fileTypeFilter,
    ...
    nonisolated static func listPath(search: String, entityType: String, fileType: String, page: Int, perPage: Int) -> String {
